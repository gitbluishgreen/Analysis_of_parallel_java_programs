...
public class GJVoidDepthFirst<A> implements GJVoidVisitor<A> {
   ...
   private ArrayList<Pair<String,String>> program_order = new ArrayList<Pair<String,String>>();
   ...
   private void solve_equation()
   {
      ...
      while(!q.isEmpty())
      {
         ...
         for(String[] a: ft.function_calls)
         {
            ...
            // if(ft.local_variables.containsKey(lhs) || ft.arguments.containsKey(lhs))
            // {
            //    new_stack.put(lhs,return_value);
            // }
            // else
            // {
            //    Set<Integer> th = new_stack.get("this");
            //    p2.second = lhs;
            //    for(int x: th)
            //    {
            //       p2.first = x;
            //       Set<Integer> sa = heap_fields.get(p2);
            //       sa.addAll(return_value);
            //       //heap_fields.put(p2,sa);
            //    }
            //    //print_heap();
            // }
         }
         if(!heap_equal(heap_fields, old_heap_fields))
         {
            ...
            for(String cl: classes.keySet())
            {
               ...
               {
                  FunctionTable ft1 = ct1.functions.get(fn);
                  if(ft1.called_functions.containsKey(p))
